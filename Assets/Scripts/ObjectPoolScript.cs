...
public class ObjectPoolScript : MonoBehaviour
{
    ...
    public GameObject GetInstance()
    {
        ...
        foreach(GameObject spawnableObject in _objectPool)
        {
            ...
            {
                //spawnableObject.GetComponent<EnemyScript>().CleanupObject();
                spawnableObject.transform.position = transform.position;
                //DebugManager.Instance.EnemiesSpawned++;
    ...
    public void RefreshPool()
    {
        ...
        if(_container == null) _container = new GameObject($"Pool Container - {_spawnableObject.name}");
    ...
    {
        //DebugManager.Instance.EnemiesDespawned++;
        instance.SetActive(false);
    }
